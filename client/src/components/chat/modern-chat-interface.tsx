...
export default function ModernChatInterface({ conversationId, initialMessages = [] }: ModernChatInterfaceProps) {
  ...
  return (
    <div className="flex h-screen bg-gradient-to-br from-[#2d3748] via-[#374151] to-[#2d3748] overflow-hidden">
      {/* Sidebar */}
      <AnimatePresence>
        {sidebarOpen && (
          <motion.div
            ...
            className="fixed inset-y-0 left-0 z-50 w-80 bg-gradient-to-b from-[#374151] via-[#4a5568]/80 to-[#374151]/80 border-r border-purple-600/40 shadow-xl backdrop-blur-lg md:relative md:shadow-none"
          >
            <div className="flex flex-col h-full">
              ...
              <div className="flex items-center justify-between p-4 border-b border-purple-600/30">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="font-bold tracking-wide bg-gradient-to-r from-purple-400 to-purple-600 bg-clip-text text-transparent">Conversations</span>
                </div>
                <Button
                  variant="ghost"
                  size="icon"
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        {messages.length === 0 && (
          <div className="flex items-center justify-between p-4 border-b border-purple-600/40 bg-gradient-to-r from-[#374151] via-purple-900/40 to-purple-800/40 backdrop-blur-lg shadow-lg">
            <div className="flex items-center space-x-3">
              <Button
                variant="ghost"
                size="icon"
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="font-bold text-white text-lg tracking-wide">Flamingo AI</span>
              </div>
            </div>
            <div className="flex items-center space-x-2">
        ...
        {messages.length > 0 && (
          <div className="flex items-center justify-between p-2 border-b border-purple-600/20 bg-[#374151]/95 backdrop-blur-lg shadow-md">
            <div className="flex items-center space-x-2">
              <button 
                onClick={() => setLocation('/')}
              ...
              <span className="font-semibold text-white text-sm tracking-wide">Flamingo</span>
            </div>
            <Button
              variant="ghost"
              size="icon"
        ...
        {/* Messages Area */}
        <div ref={chatContainerRef} className="relative flex-1 overflow-y-auto p-4 space-y-6 bg-gradient-to-b from-[#374151]/70 via-[#4a5568]/40 to-[#374151]/60 backdrop-blur-sm">
          {messages.length === 0 ? (
            <div className="flex-1 flex items-center justify-center min-h-[400px]">
              ...
              >
                ...
                >
                  <h3 className="text-3xl font-bold tracking-wide bg-gradient-to-r from-purple-400 via-purple-500 to-purple-600 bg-clip-text text-transparent mb-4">
                    Welcome to Flamingo AI
                  </h3>
                  <p className="text-gray-200 text-lg leading-relaxed mb-6 font-medium tracking-wide">
                    ...
                    <motion.div 
                      className={`w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 shadow-xl border-2 border-purple-500/30 ${
                        message.role === 'user' 
                          ...
                          : 'bg-gradient-to-br from-[#374151] via-[#4a5568] to-[#374151] border-purple-500/60'
                      }`}
                      ...
                      >
                        ...
                        <div className={`relative rounded-2xl p-4 shadow-xl backdrop-blur-sm ${
                          message.role === 'user'
                            ...
                            : 'bg-[#4a5568]/98 border border-purple-500/30 mr-4 text-white shadow-[0_0_20px_rgba(168,85,247,0.2)]'
                        }`}>
                          {/* Message tail */}
                          <div className={`absolute w-3 h-3 rotate-45 ${
                            message.role === 'user'
                              ? 'bg-gradient-to-br from-purple-600 to-purple-700 -left-1 bottom-4'
                              : 'bg-[#4a5568]/98 border-l border-b border-purple-500/30 -right-1 bottom-4'
                          }`}></div>
                          ...
                          <div className={`prose prose-sm max-w-none ${
                            ...
                            {message.role === 'assistant' ? (
                              ...
                              <p className="whitespace-pre-wrap m-0 text-sm font-medium leading-relaxed tracking-wide">{message.content}</p>
                            )}
                          </div>
                            ...
                            <div className="flex items-center justify-between mt-4 pt-3 border-t border-purple-500/20">
                              <div className="flex items-center space-x-2">
                                <div className="flex items-center space-x-1">
                                  ...
                                  <span className="text-xs font-semibold text-purple-400/90 tracking-wide">
              ...
              {isLoading && (
                ...
                >
                  <div className="flex items-end space-x-3 max-w-[85%]">
                    <div className="w-10 h-10 bg-gradient-to-br from-[#374151] via-[#4a5568] to-[#374151] rounded-full flex items-center justify-center shadow-xl border-2 border-[#22c55e]/60">
                      <Sparkles className="w-4 h-4 text-purple-400" />
                    </div>
                    <div className="relative rounded-2xl p-4 bg-[#4a5568]/95 border border-[#22c55e]/30 shadow-xl backdrop-blur-sm mr-4 shadow-[0_0_20px_rgba(34,197,94,0.2)]">
                      {/* Typing tail */}
                      <div className="absolute w-3 h-3 rotate-45 bg-[#4a5568]/95 border-l border-b border-[#22c55e]/30 -right-1 bottom-4"></div>
                      ...
                      <div ref={typingIndicatorRef} className="flex items-center space-x-2">
                        ...
                        <span className="text-sm text-[#22c55e]/90 font-semibold tracking-wide">Flamingo is thinking...</span>
                      </div>
                    </div>
                  </div>
                </motion.div>
        ...
        {/* Enhanced Input Area */}
        <div className="border-t border-[#22c55e]/30 bg-[#2d3748]/90 backdrop-blur-xl p-6 shadow-[0_-10px_30px_rgba(34,197,94,0.1)]">
          <div className="max-w-4xl mx-auto">
            <div className="flex items-end space-x-4 bg-[#374151]/90 rounded-3xl p-4 shadow-2xl backdrop-blur-sm border border-[#22c55e]/30 hover:shadow-[0_0_40px_rgba(34,197,94,0.3)] hover:border-[#22c55e]/40 transition-all duration-300 glow-input">
              <div className="flex-1">
                <Textarea
                  ...
                  className="min-h-[48px] max-h-36 resize-none border-0 bg-transparent focus:ring-0 focus:outline-none text-white placeholder-gray-300 text-base leading-relaxed font-medium tracking-wide"
                  disabled={isLoading}
