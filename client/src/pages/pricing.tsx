          ...
          >
            <div className="card">
              ...
              <div className="space-y-3">
                ...
                <button 
                  className="crypto-button w-full bg-gradient-to-r from-yellow-400 via-orange-500 to-yellow-600 text-white py-3 px-4 rounded-xl font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 animate-pulse"
                  onClick={() => setShowCryptoModal(true)}
                >
                  <span className="flex items-center justify-center">
                    <i className="fab fa-bitcoin mr-2 animate-spin"></i>
                    Pay with Crypto
                  </span>
                </button>
              </div>
